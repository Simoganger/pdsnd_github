...
def get_filters():
    """
    Asks user to specify a city, month, and day to analyze or all in case he/she want to analyse for all.
...
def load_data(city, month, day):
    """
    Loads data for the specified city and filters by month and day or all the months and days available.
